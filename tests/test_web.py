...
class WebInputTests(unittest.TestCase):
    ...
    def test_bare_terminal_defaults_to_the_answer_carousel(self) -> None:
        ...
        self.assertIn("graphLabelMetrics", script)
        ...
        self.assertIn("line-height: 2.5", style)
        self.assertIn("padding-block-end: .18em", style)
        self.assertIn("margin-inline: .15em", style)
